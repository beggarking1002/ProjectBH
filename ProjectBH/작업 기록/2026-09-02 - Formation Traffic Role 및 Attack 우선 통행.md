...
Holding의 임시 외곽 양보와 통로 동시 진입 수 제한은 다음 단계로 남겼다.

## 규칙

- Traffic Role은 `AttackIngress`, `WaitIngress`, `WaitIngressDeferred`, `HoldingTransit`, `StationaryHolding`, `PendingTransit`으로 구분한다.
